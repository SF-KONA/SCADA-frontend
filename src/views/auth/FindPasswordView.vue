        ...
        <section class="auth-container">
            <div class="auth-intro">
                ...
                <div class="intro-text">
                    <span class="intro-label">PASSWORD RECOVERY</span>
                    <h2>
                        이메일 인증 후<br />
                        임시 비밀번호를 발급합니다
                    </h2>
                    <p>
                        계정에 등록된 이메일 인증을 완료하면 임시 비밀번호를 발급받을 수 있습니다.
                    </p>
                </div>
            ...
            <div class="auth-card">
                ...
                <div class="auth-form">
                    ...
                    <div v-if="temporaryPassword" class="result-box">
                        <p>임시 비밀번호</p>
                        <strong>{{ temporaryPassword }}</strong>
                        <span v-if="resetAt">발급 시각: {{ resetAt }}</span>
                    </div>
